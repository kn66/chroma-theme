...
(defconst chroma-semantic-role-sources
  '((bg-main neutral bg-main)
    ...
    (rst-level-1-background neutral rst-level-1-background)
    (rst-level-2-background neutral rst-level-2-background)
    (rst-level-3-background neutral rst-level-3-background)
    (rst-level-4-background neutral rst-level-4-background)
    (rst-level-5-background neutral rst-level-5-background)
    (rst-level-6-background neutral rst-level-6-background)
    ...
    (blink-offscreen secondary source-green-1)
